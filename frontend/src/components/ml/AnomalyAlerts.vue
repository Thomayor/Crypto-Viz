  ...
  <div class="anomaly-alerts">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
      <div class="bg-red-900/20 border border-red-800 p-4 rounded-lg">
        <div class="flex items-center justify-between">
          <div>
            <div class="text-sm text-red-400">Critical</div>
      ...
      <div class="bg-orange-900/20 border border-orange-800 p-4 rounded-lg">
        <div class="flex items-center justify-between">
          <div>
            <div class="text-sm text-orange-400">High</div>
      ...
      <div class="bg-yellow-900/20 border border-yellow-800 p-4 rounded-lg">
        <div class="flex items-center justify-between">
          <div>
            <div class="text-sm text-yellow-400">Medium</div>
      ...
      <div class="bg-blue-900/20 border border-blue-800 p-4 rounded-lg">
        <div class="flex items-center justify-between">
          <div>
            <div class="text-sm text-blue-400">Low</div>
    ...
    <div class="space-y-4">
      ...
      <div v-else-if="anomalies.length === 0" class="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700/50 p-8 text-center">
        ...
        <p class="text-gray-300 mb-2">No active anomalies detected</p>
        ...
        <div class="p-6">
          <div class="flex items-start justify-between mb-4">
            ...
            <button
              ...
              class="ml-4 px-3 py-1 bg-gray-700 hover:bg-gray-600 text-gray-300 rounded text-sm font-medium transition-colors"
            >
              Resolve
            </button>
          </div>
          ...
          <div class="bg-gray-900 rounded-lg p-4">
            <div class="grid grid-cols-3 gap-4 text-sm">
              ...
              <div v-if="anomaly.actual_value">
                <div class="text-gray-400">Actual</div>
              ...
              <div v-if="anomaly.deviation">
                <div class="text-gray-400">Deviation</div>
...
function getValueChangeClass(expected: number | null, actual: number | null): string {
  if (!expected || !actual) return 'text-white'
